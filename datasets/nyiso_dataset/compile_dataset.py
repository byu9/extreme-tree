...
def _compile_dataset_for_da(dataset):
    ...
    dataset = dataset.resample('1d').max()
    ...
    for zone in dataset.columns.get_level_values(0):
        ...
        _save_feature(zonal_train, f'../train/feature-nyiso-{zona_name}.csv')
        _save_feature(zonal_test, f'../test/feature-nyiso-{zona_name}.csv')
        _save_target(zonal_train, f'../train/target-nyiso-{zona_name}.csv')
        _save_target(zonal_test, f'../test/target-nyiso-{zona_name}.csv')
